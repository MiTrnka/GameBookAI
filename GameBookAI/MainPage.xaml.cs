...
public partial class MainPage : ContentPage
{
    ...
    private async void HratKviz(string popisHry)
    {
        string popisPravidel =
                "Jsi moderátor kvízu. " +
                "Dávej vždy jen jednu otázku z požadovaného tématu. " +
    ...
    {
        HratPribeh("Jsi Markéta Trnková, bydlíš ve městě Karlovy Vary v ulici Zámecký vrch 411 ve starším domě v posledním 5. patře pod půdou. Na patře jste jedinný byt. S tebou v bytě bydlí tvůj tvůj syn Tobiáš (2 měsíce) a manžel Michal (programátor). Máte ještě 2 černobílé kočky. Příběh bude trochu strašidelný. Zjisti si mapu okolí, ať tvůj popis sedí s realitou. Příběh se bude točit okolo Tobiáše, u kterého se postupem příběhu dozvíme, že je tajuplně geniální a to v tajuplném a dobrém smyslu.");
    }
